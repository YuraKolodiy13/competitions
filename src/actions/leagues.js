...
export const EDIT_COMPETITION_REQUEST_SUCCESS = 'EDIT_COMPETITION_REQUEST_SUCCESS';
export const EDIT_COMPETITION_REQUEST_FAILED = 'EDIT_COMPETITION_REQUEST_FAILED';
export const editCompetitionRequest = defaultActionCreator(EDIT_COMPETITION_REQUEST, 'data', 'callback');
...
export const ADD_GAME_REQUEST_SUCCESS = 'ADD_GAME_REQUEST_SUCCESS';
export const ADD_GAME_REQUEST_FAILED = 'ADD_GAME_REQUEST_FAILED';
export const addGameRequest = defaultActionCreator(ADD_GAME_REQUEST, 'data', 'callback');

export const REMOVE_GROUP_REQUEST = 'REMOVE_GROUP_REQUEST';
export const REMOVE_GROUP_REQUEST_SUCCESS = 'REMOVE_GROUP_REQUEST_SUCCESS';
export const REMOVE_GROUP_REQUEST_FAILED = 'REMOVE_GROUP_REQUEST_FAILED';
export const removeGroupRequest = defaultActionCreator(REMOVE_GROUP_REQUEST, 'data');
